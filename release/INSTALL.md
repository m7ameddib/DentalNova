# DNT Dental v1.1.2 — Installation Guide

## Package contents

- **DNT-Dental-Main-Clinic-Setup-v1.1.2.exe** — Windows installer for the main clinic computer (recommended)
...
1. Run **DNT-Dental-Main-Clinic-Setup-v1.1.2.exe**
...
**DNT Dental v1.1.2** — DibNova Technologies
