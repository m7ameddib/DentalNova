...
export const SYNC_ENTITIES: SyncEntityDef[] = [
  ...
  {
    name: 'appointment_walkins',
    table: 'appointment_walkins',
    fks: { appointment_id: 'appointments', created_by_id: 'users' },
    conflict: 'review',
  },
  {
  ...
  { name: 'lab_case_teeth', table: 'lab_case_teeth', fks: { lab_case_id: 'lab_cases' }, conflict: 'lww-safe' },
  {
    ...
    fks: { lab_case_id: 'lab_cases', recorded_by_id: 'users', voided_by_id: 'users' },
    conflict: 'immutable',
  },
  {
    name: 'clinic_expenses',
    table: 'clinic_expenses',
    fks: { expense_category_id: 'expense_categories', created_by_id: 'users', voided_by_id: 'users' },
    conflict: 'review',
  },
  {
    name: 'lab_account_payments',
    table: 'lab_account_payments',
    fks: { lab_name_id: 'lab_names', recorded_by_id: 'users', voided_by_id: 'users' },
    conflict: 'immutable',
  },
